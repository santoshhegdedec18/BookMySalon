...
var Constants = (function() {
    ...
    var URLConstants = (function() {
		function URLConstants() {
			...
			this.createBusiness = HOSTNAME + "/createbusiness";
			this.getAllBusiness = HOSTNAME + "/allbusiness";
			this.getBusinessByUserNane = HOSTNAME + "/validate/business/{username}";

			//Upload images
			this.UploadImages = HOSTNAME + "/uploadimages/{username}";

			//Ratings related
			this.addRating = HOSTNAME + "/addRating";			
			this.getBusinessRating = HOSTNAME + "/getBusinessRating/{bizid}";

			//Reviews related
			this.addReview = HOSTNAME + "/addReview";			
			this.getBusinessReviews = HOSTNAME + "/getBusinessReviews/{bizid}";
